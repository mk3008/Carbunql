...
public static class MergeQueryExtensions
{
    ...
    public static MergeQuery NotMatchedInsert(this MergeQuery source, Func<ValueBase>? conditionBuilder = null)
    {
    ...
    /// </summary>
    /// <param name="source">The merge query.</param>
    public static MergeQuery NotMathcedInsertAsAutoNumber(this MergeQuery source)
    {
    ...
    public static MergeQuery MatchedUpdate(this MergeQuery source, Func<ValueBase>? conditionBuilder = null)
    {
    ...
    public static MergeQuery MatchedDelete(this MergeQuery source, Func<ValueBase>? conditionBuilder = null)
    {
